...
func NewClient(ctx context.Context, config Config) (Client, error) {
	...
	ueClient := uenib.NewUEServiceClient(conn)
...
func (c *Client) getUEWithGlobalID(ctx context.Context, ueGlobalId string) (uenib.UE, error) {
	...
	// gets an UE response
	resp, err := c.ueClient.GetUE(ctx, req)
	if err != nil {
		return uenib.UE{}, err
	}
...
func (c *Client) GetRsmUEs(ctx context.Context) ([]*uenib.RsmUeInfo, error) {
	...
	stream, err := c.ueClient.ListUEs(ctx, &uenib.ListUERequest{})
	if err != nil {
...
func (c *Client) AddRsmUE(ctx context.Context, rsmUeAspect *uenib.RsmUeInfo) error {
	...
	// creates UE
	resp, err := c.ueClient.CreateUE(ctx, req)
	if err != nil {
		log.Warn(err)
	}
...
func (c *Client) UpdateRsmUE(ctx context.Context, rsmUeAspect *uenib.RsmUeInfo) error {
	...
	// updates UE
	resp, err := c.ueClient.UpdateUE(ctx, req)
	if err != nil {
		return err
	}
...
func (c *Client) DeleteUE(ctx context.Context, ueGlobalId string) error {
	...
	// deletes UE
	resp, err := c.ueClient.DeleteUE(ctx, req)
	if err != nil {
		return err
	}
